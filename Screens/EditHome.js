...
export default class EditHome extends Component {
    state = {
        ...
        lng: '',
        ErrorMessege: '',
        c_tool: this.props.route.params.Item.c_tool,
        c_tool1: this.props.route.params.Item.c_tool1,
        c_tool2: this.props.route.params.Item.c_tool2,
        c_tool3: this.props.route.params.Item.c_tool3,
        c_tool4: this.props.route.params.Item.c_tool4,
        breedName: this.props.route.params.Item.breedName,
        imageuser:this.props.route.params.Item.imageuser,
    ...
    UploadData = async () => {
        ...
        if (this.state.breedName) {
            if (this.state.imageuser) {
                ...
                if(downloadURL){    
                let success = await saveData('breedData',this.state.id,{
                        id:this.state.id,
                        ...
                        ToastAndroid.show("Breed data is updated successfully", ToastAndroid.SHORT);
                       this.props.navigation.navigate('AdminViewALL')
